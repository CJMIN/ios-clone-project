...
func fetchCurrentWeather(cityName :String,completion : @escaping (Result<CurrentWeather, Error>) -> () ){
    ...
    let urlStr =  "https://api.openweathermap.org/data/2.5/weather?q=\(cityName)&appid=b39aeb1e660919371efad86125f1a70d&units=metric&lang=kr"
...
func fetchCurrentWeather(cityId :Int,completion : @escaping (Result<CurrentWeather, Error>) -> () ){
    ...
    let urlStr =  "https://api.openweathermap.org/data/2.5/weather?id=\(cityId)&appid=b39aeb1e660919371efad86125f1a70d&units=metric&lang=kr"
...
func fetchCurrentWeather(location :CLLocation,completion : @escaping (Result<CurrentWeather, Error>) -> () ){
    ...
    let urlStr =  "https://api.openweathermap.org/data/2.5/weather?lat=\(location.coordinate.latitude)&lon=\(location.coordinate.longitude)&appid=b39aeb1e660919371efad86125f1a70d&units=metric&lang=kr"
